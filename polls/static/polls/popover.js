...
class Popover {
  constructor(trigger, { position = 'bottom', className = 'popover' }) {
    this.trigger = trigger;
    this.position = position;
    this.className = className;
    this.orderedPositions = ['bottom', 'top', 'right',  'left'];
  ...
  show() {
    ...
    this.content.appendChild(this.popover);
    this.popover.style.marginTop = `${scrollTop + 15}px`;
...
trigger.addEventListener('click', (e) => popover.toggle());